        ...
        <div class="grid">
            <div class="map">
                <div v-if="activeTweet" class="mt-05 mb-05 ml-05 fill-darker rounded p-05" :class="{ 'fill-red color-lighter': activeTweetToday }">
                    ...
                    <p class="mt-05 mb-05 text-small"><span v-html="parseTweet(activeTweet.text)"></span> - <a class="tweet-mention" href="https://twitter.com/policialocalvlc" target="_blank">@policialocalvlc</a></p>
                </div>
            ...
            <div v-if="tweets" class="tweet-list">
                ...
                <div class="credits">
                    <p class="text-small color-faded">&copy; 2017 <a href="https://lumby.me/" target="_blank">Oliver Lumby</a></p>
